...
//        TopLevelClass interfaze = new TopLevelClass(type);
        ...
        //继承类
        FullyQualifiedJavaType supperType = FullyQualifiedJavaType.getMapperSuper();
        supperType.addTypeArgument(new FullyQualifiedJavaType(this.introspectedTable.getBaseRecordType()));
        interfaze.addSuperInterface(supperType);
        ...
        interfaze.addAnnotation("@Repository(\""+this.introspectedTable.getMyBatis3SqlMapNamespace()+"\")");
//        System.out.println(this.introspectedTable.getMyBatis3FallbackSqlMapNamespace());
//        System.out.println(this.introspectedTable.getMyBatis3JavaMapperType());
//        System.out.println(this.introspectedTable.getMyBatis3SqlMapNamespace());
//        System.out.println(this.introspectedTable.getMyBatis3SqlProviderType());
//        System.out.println(this.introspectedTable.getMyBatis3UpdateByExampleWhereClauseId());
//        System.out.println(this.introspectedTable.getMyBatis3XmlMapperFileName());
//        System.out.println(this.introspectedTable.getMyBatis3XmlMapperPackage());
//        System.out.println(this.introspectedTable.getBaseRecordType());
//        System.out.println(this.introspectedTable.getBaseColumnListId());
//        System.out.println(this.introspectedTable.getBaseColumns());
//        System.out.println(this.introspectedTable.getBaseResultMapId());
//        System.out.println(this.introspectedTable.getTableConfiguration().getMapperName());
//        System.out.println(this.introspectedTable.getTableConfiguration().getDomainObjectName());
//        System.out.println(this.introspectedTable.getTableConfiguration().getSchema());
        interfaze.addImportedType(new FullyQualifiedJavaType("org.springframework.stereotype.Repository"));

        addPaginateMethod(interfaze);
...
//        addUpdateByPrimaryKeyWithoutBLOBsMethod(interfaze);
    ...
    protected void addPaginateMethod(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new  PaginateMethodGenerator();
