...
public class FullyQualifiedJavaType implements
    ...
    private static FullyQualifiedJavaType paginate = null;
    ...
    public static final FullyQualifiedJavaType getMapperSuper() {
        return new FullyQualifiedJavaType("com.inspur.mng.core.ibatis.MapperBaseDao"); //$NON-NLS-1$
    }
    ...
    public static final FullyQualifiedJavaType getPaginate() {
        return new FullyQualifiedJavaType("com.inspur.mng.core.page.Page<com.inspur.mng.core.db.Record>"); //$NON-NLS-1$
    }
    ...
    public static final FullyQualifiedJavaType getNewPageInstance() {
        // always return a new instance because the type may be parameterized
        return new FullyQualifiedJavaType("com.inspur.mng.core.page.Page"); //$NON-NLS-1$
    }
    public static final FullyQualifiedJavaType getNewRecordInstance() {
        // always return a new instance because the type may be parameterized
        return new FullyQualifiedJavaType("com.inspur.mng.core.db.Record"); //$NON-NLS-1$
    }
