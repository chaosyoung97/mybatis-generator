...
public class TkMyBatis3Impl extends IntrospectedTableMyBatis3Impl {
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        ...
        if (stringHasValue(tableConfiguration.getMapperName())) {
            ...
            sb.append(fullyQualifiedTable.getDomainObjectName().substring(0,fullyQualifiedTable.getDomainObjectName().length())+"Mapper");
           // sb.append(MessageFormat.format(mapperName, fullyQualifiedTable.getDomainObjectName()));
            sb.append(".xml"); //$NON-NLS-1$
        } else {
            sb.append(fullyQualifiedTable.getDomainObjectName().substring(0,fullyQualifiedTable.getDomainObjectName().length()));
