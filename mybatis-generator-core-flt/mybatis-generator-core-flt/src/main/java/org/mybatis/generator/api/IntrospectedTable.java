...
/**
 * Created by JIANGPING on 2019/4/9.
 */
...
//        this.setCountByExampleStatementId("count"+this.tableConfiguration.getDomainObjectName()+"ByExample");
//        this.setDeleteByExampleStatementId("delete"+this.tableConfiguration.getDomainObjectName()+"ByExample");
//        this.setDeleteByPrimaryKeyStatementId("delete"+this.tableConfiguration.getDomainObjectName());
//        this.setInsertStatementId("save");
...
//        this.setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause");
        ...
        this.setDeleteByPrimaryKeyStatementId("delete" + this.tableConfiguration.getDomainObjectName() + "ByPrimaryKey");
        this.setInsertStatementId("insert" + this.tableConfiguration.getDomainObjectName());
        this.setInsertSelectiveStatementId("insert" + this.tableConfiguration.getDomainObjectName() + "BySelective");
        this.setSelectAllStatementId("selectAll" + this.tableConfiguration.getDomainObjectName());
        this.setSelectByExampleStatementId("selectByExample");
        this.setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs");
        this.setSelectByPrimaryKeyStatementId("select" + this.tableConfiguration.getDomainObjectName() + "ByPrimaryKey");
        this.setUpdateByExampleStatementId("update" + this.tableConfiguration.getDomainObjectName() + "ByExample");
        this.setUpdateByExampleSelectiveStatementId("updateByExampleSelective");
        this.setUpdateByExampleWithBLOBsStatementId("updateByExampleWithBLOBs");
        this.setUpdateByPrimaryKeyStatementId("update" + this.tableConfiguration.getDomainObjectName() + "ByPrimaryKey");
        this.setUpdateByPrimaryKeySelectiveStatementId("update" + this.tableConfiguration.getDomainObjectName() + "ByPrimaryKeySelective");
        this.setUpdateByPrimaryKeyWithBLOBsStatementId("updateByPrimaryKeyWithBLOBs");
        this.setBaseResultMapId(this.tableConfiguration.getDomainObjectName() + "ResultMap");
        this.setResultMapWithBLOBsId("ResultMapWithBLOBs");
        this.setExampleWhereClauseId("Example_Where_Clause");
        this.setBaseColumnListId(this.tableConfiguration.getDomainObjectName() + "ColumnList");
        this.setBlobColumnListId("Blob_Column_List");
        this.setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause");
    }
    ...
    public String getMyBatisDynamicSqlSupportType() {
        return (String)this.internalAttributes.get(IntrospectedTable.InternalAttribute.ATTR_MYBATIS_DYNAMIC_SQL_SUPPORT_TYPE);
    }

    public void setMyBatisDynamicSqlSupportType(String s) {
        this.internalAttributes.put(IntrospectedTable.InternalAttribute.ATTR_MYBATIS_DYNAMIC_SQL_SUPPORT_TYPE, s);
    }
