...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setDeleteByPrimaryKeyStatementId("delete"+this.tableConfiguration.getDomainObjectName()+"ByPrimaryKey"); //$NON-NLS-1$
        setInsertStatementId("insert"+this.tableConfiguration.getDomainObjectName()); //$NON-NLS-1$
        setInsertSelectiveStatementId("insert"+this.tableConfiguration.getDomainObjectName()+"BySelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"+this.tableConfiguration.getDomainObjectName()); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("select"+this.tableConfiguration.getDomainObjectName()+"ByPrimaryKey"); //$NON-NLS-1$
        setUpdateByExampleStatementId("update"+this.tableConfiguration.getDomainObjectName()+"ByExample"); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeyStatementId("update"+this.tableConfiguration.getDomainObjectName()+"ByPrimaryKey"); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId("update"+this.tableConfiguration.getDomainObjectName()+"ByPrimaryKeySelective"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateByPrimaryKeyWithBLOBs"); //$NON-NLS-1$
        setBaseResultMapId(this.tableConfiguration.getDomainObjectName()+"ResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId("Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId(this.tableConfiguration.getDomainObjectName()+"ColumnList"); //$NON-NLS-1$
